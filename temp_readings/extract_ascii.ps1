...
# Decode Base Path
$b1 = "RAA6AFwARABlAHMAawB0AG8AcABcAAlOuWVzXvBTeZjudlwACU4fZwCXQmw="
$targetDir = $enc.GetString([System.Convert]::FromBase64String($b1))
# Decode Sub Path
$b2 = "AJdCbAZSkGelYkpU"
$reportDirName = $enc.GetString([System.Convert]::FromBase64String($b2))
...
if (Test-Path $targetDir) {
    ...
    $sd = Join-Path $targetDir $reportDirName
    if (Test-Path $sd) {
